...
```{r echo=FALSE, out.width='65%', fig.cap= "Recruitment of Schools"}
...
knitr:: kable(df_std_coefficients, caption = "Table 1.Mood is signficantly associated with surprises across experiments", digits = 2)
```
