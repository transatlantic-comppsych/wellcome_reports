...
### Survey-based school study

-   In this study, we examined age-related effects on self-focused attention across adolescence and its relationship with symptoms social anxiety and depression. We expected a normative increase in self-focused attention across adolescence. We also expected that self-focused attention would partially explain age effects on symptoms of social anxiety and depression. A sample of 638 adolescents aged 11-18 years (53% male) were recruited through two government-funded secondary school students and completed validated self-reported measures. As hypothesised, we found age to be positively associated with self-focused attention (*B* = 1.45, *p* \< .001). Moreover, self-focused attention fully mediated the effect of age on social anxiety symptoms, and partially mediated age effects on symptoms of BDD and depression. The findings provide support for the notion that increases in self-focused attention may partly account for the rise in symptoms social anxiety and depression during adolescence. This study has recently been submitted for publication. The findings have reinforced our commitment to developing experimental paradigms to test the causal role of self-focused attention in social anxiety (led by Naomi Tromans, as described above).
